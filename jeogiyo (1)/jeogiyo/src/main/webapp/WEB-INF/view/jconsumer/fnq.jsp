...
<div id=question_1>
    ...
    <button id='btnToggle_1' onclick='Toggle_1()'>확인</button></div><br/>
...
<div id=question_2>
    ...
    <button id='btnToggle_2' onclick='Toggle_2()'>확인</button></div><br/>
...
<div id=question_3>
    ...
    <button id='btnToggle_3' onclick='Toggle_3()'>확인</button></div><br/>
...
<div id=question_4>
    ...
    <button id='btnToggle_4' onclick='Toggle_4()'>확인</button></div><br/>
...
<div id=question_5>
    ...
    <button id='btnToggle_5' onclick='Toggle_5()'>확인</button></div><br/>
...
<div id=question_6>
    ...
    <button id='btnToggle_6' onclick='Toggle_6()'>확인</button></div><br/>
...
<div id=question_7>
    ...
    <button id='btnToggle_7' onclick='Toggle_7()'>확인</button></div><br/>
...
<div id=question_8>
    ...
    <button id='btnToggle_8' onclick='Toggle_8()'>확인</button></div><br/>
